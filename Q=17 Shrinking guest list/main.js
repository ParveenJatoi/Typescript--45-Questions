...
var guestList = ['Parsa', 'Anaya', 'Aleena', 'Fatima'];
...
while (guestList.length > 2) {
    var removesGuest = guestList.pop();
    console.log("sorry ".concat(removesGuest, " i cant invite you at dinner"));
}
...
guestList.forEach(function (lasttwo) { return console.log("luckely ".concat(lasttwo, ",You are still invited at dinner")); });
guestList.pop();
guestList.pop();
